...
OBJECTS = game.o gameObject.o rectangle.o borderDisplay.o gameDisplay.o border.o bitmap.o character.o statusDisplay.o iceCreamDrop.o keyboard.o controller.o iceCream.o iceCreamDisplay.o fly.o
DEPENDS = ${OBJECTS:.o=.d}
